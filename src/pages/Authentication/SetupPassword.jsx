  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 sm:p-0">
      <div className="grid md:grid-cols-2 rounded-4xl items-stretch max-w-7xl w-full bg-white shadow-lg overflow-hidden">
        ...
        <div style={{ backgroundColor: "#EAEAEA" }} className="h-full hidden md:flex flex-col items-center justify-between ">
          {/* Top Image */}
          ...
          <div className="h-full w-full">
            <img src={'/login-image.png'} className="w-full h-full object-cover" alt="Illustration" />
          </div>
        </div>
      </div>
    </div>
